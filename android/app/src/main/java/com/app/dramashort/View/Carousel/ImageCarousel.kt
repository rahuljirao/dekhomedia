package com.app.dramashort.View.Carousel
...
import com.app.dramashort.View.Carousel.adapter.FiniteCarouselAdapter
import com.app.dramashort.View.Carousel.adapter.InfiniteCarouselAdapter
import com.app.dramashort.View.Carousel.listener.CarouselListener
import com.app.dramashort.View.Carousel.listener.CarouselOnScrollListener
...
import com.app.dramashort.View.Carousel.utils.CarouselLinearLayoutManager
import com.app.dramashort.View.Carousel.utils.LinearStartSnapHelper
import com.app.dramashort.View.Carousel.utils.dpToPx
import com.app.dramashort.View.Carousel.utils.getSnapPosition
...
class ImageCarousel(
    ...
    var showTopShadow = false
        set(value) {
            ...
            viewTopShadow.visibility = if (showTopShadow) VISIBLE else GONE
        }
    ...
    @Dimension(unit = Dimension.Companion.PX)
    ...
    var showBottomShadow = false
        set(value) {
            ...
            viewBottomShadow.visibility = if (showBottomShadow) VISIBLE else GONE
        }
    ...
    var showCaption = false
        set(value) {
            ...
            tvCaption.visibility = if (showCaption) VISIBLE else GONE
        }
    ...
    var showNavigationButtons = false
        set(value) {
            ...
            previousButtonContainer.visibility =
                if (showNavigationButtons) VISIBLE else GONE
    ...
    private fun initIndicator() {
        ...
        indicator?.apply {
            if (isBuiltInIndicator) {
                ...
                this.visibility = if (showIndicator) VISIBLE else GONE
            }
