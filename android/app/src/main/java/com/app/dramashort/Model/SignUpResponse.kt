...
data class SignUpResponse(
    ...
    data class ResponseDetails(
        ...
        val isYearlyVip: Int?,
        @SerializedName("is_monthly_vip")
        val isMonthlyVip: Int?,
        ...
        val weeklyVipEnded: String?,
        @SerializedName("yearly_vip_ended")
        val yearlyVipEnded: String?,
        @SerializedName("monthly_vip_ended")
        val monthlyVipEnded: String?
